...
.orgrow{display:flex;gap:36px;flex-wrap:wrap;margin:6px 0 10px}
.org{width:240px;font-size:14px;line-height:1.45;color:#444}
.org .portrait{width:150px;aspect-ratio:4/5;object-fit:cover;margin-bottom:8px}
.org b{color:#1b2a4e;font-size:15.5px}
